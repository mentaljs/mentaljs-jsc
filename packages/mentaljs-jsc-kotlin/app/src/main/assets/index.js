...
var NativeEventEmitter = __webpack_require__(1);
...
var ReactNativeRenderer_createReconciler = function createReconciler(onChanged) {
  return react_reconciler_default()({
    ...
    // Commit lifecycle
    prepareForCommit: function prepareForCommit() {// console.log('UIManager: Prepare');
      // TODO: Call callback
    },
...
// CONCATENATED MODULE: ./packages/mentaljs-jsc-view/internals/ViewEvents.tsx
function ViewEvents_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ViewEvents_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }



var ViewEvents_ViewEventsImpl = function ViewEventsImpl() {
  var _this = this;

  ViewEvents_classCallCheck(this, ViewEventsImpl);

  ViewEvents_defineProperty(this, "nextId", 0);

  ViewEvents_defineProperty(this, "callbacks", new Map());

  ViewEvents_defineProperty(this, "eventEmitter", new NativeEventEmitter["a" /* NativeEventEmitter */]('UIManager'));

  ViewEvents_defineProperty(this, "registerCallback", function (handler) {
    var key = 'c' + _this.nextId++;
    console.log('UIManager: Register callback');

    _this.callbacks.set(key, handler);

    return key;
  });

  ViewEvents_defineProperty(this, "unregisterCallback", function (key) {
    _this.callbacks.delete(key);
  });

  this.eventEmitter.subscribe('event', function (e) {
    console.log('UIManager: Received event');
    var key = e.key;
    var args = e.args;

    var cb = _this.callbacks.get(key);
...
var ViewEvents = new ViewEvents_ViewEventsImpl();
...
function createView_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function createView_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function createView_createClass(Constructor, protoProps, staticProps) { if (protoProps) createView_defineProperties(Constructor.prototype, protoProps); if (staticProps) createView_defineProperties(Constructor, staticProps); return Constructor; }
...
function createView_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function createView(name) {
  ...
  var res = (_temp = _class =
  /*#__PURE__*/
  function (_React$PureComponent) {
    _inherits(NativeView, _React$PureComponent);

    function NativeView(props) {
      var _this;

      createView_classCallCheck(this, NativeView);

      _this = _possibleConstructorReturn(this, _getPrototypeOf(NativeView).call(this, props));

      createView_defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "registeredCallbacks", {});

      var _loop = function _loop(k) {
        if (typeof props[k] === 'function') {
          _this.registeredCallbacks[k] = ViewEvents.registerCallback(function (args) {
            if (_this.props[k]) {
              _this.props[k](args);
            }
          });
    ...
    createView_createClass(NativeView, [{
      ...
      value: function componentWillUpdate(nextProps) {
        ...
        var _loop2 = function _loop2(k) {
          if (typeof nextProps[k] === 'function') {
            if (!_this2.registeredCallbacks[k]) {
              _this2.registeredCallbacks[k] = ViewEvents.registerCallback(function (args) {
                if (_this2.props[k]) {
                  _this2.props[k](args);
                }
              });
      ...
      value: function componentWillUnmount() {
        for (var cb in this.registeredCallbacks) {
    ...
    return NativeView;
  }(react["PureComponent"]), createView_defineProperty(_class, "displayName", name), _temp);
  return res; // return (props:T) => {
  //     return <asyncview asyncViewName={name} {...props} />
  // };
}
// CONCATENATED MODULE: ./packages/mentaljs-jsc-view/index.ts

// CONCATENATED MODULE: ./packages/mentaljs-jsc-view/internals/normalizeColor.tsx
...
// CONCATENATED MODULE: ./packages/mentaljs-jsc-view/internals/processColor.tsx
...
function processColor(color) {
  ...
  int32Color = (int32Color << 24 | int32Color >>> 8) >>> 0; // if (Platform.OS === 'android') {
...
function mentaljs_jsc_sandbox_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { mentaljs_jsc_sandbox_typeof = function _typeof(obj) { return typeof obj; }; } else { mentaljs_jsc_sandbox_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return mentaljs_jsc_sandbox_typeof(obj); }

var mentaljs_jsc_sandbox_REACT_ELEMENT_TYPE;

function mentaljs_jsc_sandbox_jsx(type, props, key, children) { if (!mentaljs_jsc_sandbox_REACT_ELEMENT_TYPE) { mentaljs_jsc_sandbox_REACT_ELEMENT_TYPE = typeof Symbol === "function" && Symbol.for && Symbol.for("react.element") || 0xeac7; } var defaultProps = type && type.defaultProps; var childrenLength = arguments.length - 3; if (!props && childrenLength !== 0) { props = { children: void 0 }; } if (props && defaultProps) { for (var propName in defaultProps) { if (props[propName] === void 0) { props[propName] = defaultProps[propName]; } } } else if (!props) { props = defaultProps || {}; } if (childrenLength === 1) { props.children = children; } else if (childrenLength > 1) { var childArray = new Array(childrenLength); for (var i = 0; i < childrenLength; i++) { childArray[i] = arguments[i + 3]; } props.children = childArray; } return { $$typeof: mentaljs_jsc_sandbox_REACT_ELEMENT_TYPE, type: type, key: key === undefined ? null : '' + key, ref: null, props: props, _owner: null }; }

function mentaljs_jsc_sandbox_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function mentaljs_jsc_sandbox_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function mentaljs_jsc_sandbox_createClass(Constructor, protoProps, staticProps) { if (protoProps) mentaljs_jsc_sandbox_defineProperties(Constructor.prototype, protoProps); if (staticProps) mentaljs_jsc_sandbox_defineProperties(Constructor, staticProps); return Constructor; }

function mentaljs_jsc_sandbox_possibleConstructorReturn(self, call) { if (call && (mentaljs_jsc_sandbox_typeof(call) === "object" || typeof call === "function")) { return call; } return mentaljs_jsc_sandbox_assertThisInitialized(self); }

function mentaljs_jsc_sandbox_getPrototypeOf(o) { mentaljs_jsc_sandbox_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return mentaljs_jsc_sandbox_getPrototypeOf(o); }

function mentaljs_jsc_sandbox_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) mentaljs_jsc_sandbox_setPrototypeOf(subClass, superClass); }

function mentaljs_jsc_sandbox_setPrototypeOf(o, p) { mentaljs_jsc_sandbox_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return mentaljs_jsc_sandbox_setPrototypeOf(o, p); }

function mentaljs_jsc_sandbox_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function mentaljs_jsc_sandbox_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function mentaljs_jsc_sandbox_extends() { mentaljs_jsc_sandbox_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return mentaljs_jsc_sandbox_extends.apply(this, arguments); }

function mentaljs_jsc_sandbox_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = mentaljs_jsc_sandbox_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }

function mentaljs_jsc_sandbox_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
var XViewNative = createView('XView');

var mentaljs_jsc_sandbox_XView = function XView(props) {
  var backgroundColor = props.backgroundColor,
      other = mentaljs_jsc_sandbox_objectWithoutProperties(props, ["backgroundColor"]);

  return react["createElement"](XViewNative, mentaljs_jsc_sandbox_extends({}, other, {
    backgroundColor: processColor(backgroundColor)
  }));
};

var View = mentaljs_jsc_sandbox_XView;

var _ref =
/*#__PURE__*/
mentaljs_jsc_sandbox_jsx(mentaljs_jsc_sandbox_XView, {
  width: 100,
  height: 100,
...
var _ref2 =
/*#__PURE__*/
mentaljs_jsc_sandbox_jsx(View, {}, void 0, mentaljs_jsc_sandbox_jsx(View, {
  width: 100,
  height: 100,
  backgroundColor: "red"
}), mentaljs_jsc_sandbox_jsx(View, {
  width: 100,
  height: 100,
...
function (_React$Component) {
  mentaljs_jsc_sandbox_inherits(RootView, _React$Component);
  ...
  function RootView() {
    ...
    mentaljs_jsc_sandbox_classCallCheck(this, RootView);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = mentaljs_jsc_sandbox_possibleConstructorReturn(this, (_getPrototypeOf2 = mentaljs_jsc_sandbox_getPrototypeOf(RootView)).call.apply(_getPrototypeOf2, [this].concat(args)));

    mentaljs_jsc_sandbox_defineProperty(mentaljs_jsc_sandbox_assertThisInitialized(mentaljs_jsc_sandbox_assertThisInitialized(_this)), "state", {
      color: 'red'
    });
  ...
  mentaljs_jsc_sandbox_createClass(RootView, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      ...
      var res = mentaljs_jsc_sandbox_jsx(mentaljs_jsc_sandbox_XView, {}, void 0, _ref, mentaljs_jsc_sandbox_jsx(mentaljs_jsc_sandbox_XView, {
        ...
        onPress: function onPress() {
          return _this2.setState({
            color: _this2.state.color === 'red' ? 'blue' : 'red'
          });
        },
        animate: "all"
      }), this.state.color === 'red' && _ref2);
  ...
  return RootView;
}(react["Component"]); // const RootView = () => {
